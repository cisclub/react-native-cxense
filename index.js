...
const Cxense = {
     ...
     * @param callbackHandler   (callback) = > {} function called after initialisation is done. if callback equals to NULL/Undefined this means initialisation was successful otherwise it will contain the error.
     */
    trackEvent(name, siteID, location, customParameterKey, customParameterValue, profileParameterKey = null, profileParameterValue = null, extraParameterKey = null, extraParameterValue = null, callBackHandler = () => {}) {
